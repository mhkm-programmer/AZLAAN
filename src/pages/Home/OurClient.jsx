...
const OurClient = () => {
  ...
  const items = logos.map((logo, index) => (
    ...
    >
      <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow hover:shadow-xl transition-shadow duration-300 w-36 h-20 flex items-center justify-center">
        <img
          src={logo.src}
          alt={logo.alt}
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-[#f8f8f8] to-[#f0e7d8] dark:from-gray-900 dark:to-gray-800">
      <div className="container px-6 mx-auto text-center">
        <div className="mb-10">
          <h2 className="text-4xl font-extrabold tracking-tight text-[#6B4226] dark:text-white">
            Our Valued Clients
          </h2>
          <p className="mt-2 text-gray-600 dark:text-gray-300 text-lg">
            Trusted partnerships with leaders in Qatar's interior and construction industries.
          </p>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400 font-medium">
            عملاؤنا الكرام من كبرى شركات التصميم الداخلي والتشطيبات في قطر
          </p>
        </div>
