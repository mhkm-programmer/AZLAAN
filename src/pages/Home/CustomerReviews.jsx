...
const CustomerReviews = () => {
  const reviews = [
    ...
    },
    {
      ...
      quoteEn: "From concept to execution, they were truly professional and creative.",
      quoteAr: "من الفكرة إلى التنفيذ، كانوا محترفين ومبدعين بالفعل.",
      name: "Mohammed Khalifa",
      title: "Architect, Lusail",
    },
    {
  ...
  const items = reviews.map((review, index) => (
    <div
      key={index}
      className="flex flex-col items-center p-8 mx-4 bg-white dark:bg-gray-900 rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 ease-in-out transform hover:scale-[1.03]"
    >
      <img
        src={review.image}
        alt={review.name}
      ...
      <div className="text-center max-w-xs">
        <p className="text-gray-800 dark:text-gray-200 italic text-base leading-relaxed mb-2">
          “{review.quoteEn}”
        </p>
        <p dir="rtl" className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed mb-3 font-medium">
          "{review.quoteAr}"
        </p>
    ...
    <section className="py-20 bg-gradient-to-br from-[#fdf9f4] to-[#e8dfd4] dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-6">
        <div className="text-center mb-14">
          <h2 className="text-4xl md:text-5xl font-extrabold text-[#8B6B47] dark:text-white mb-4 tracking-wide">
          ...
          <p className="text-[#8B6B47] dark:text-[#e0c7a6] text-sm mt-2" dir="rtl">
